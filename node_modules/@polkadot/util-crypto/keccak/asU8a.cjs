...
var _sha = require("../noble-hashes/lib/sha3.cjs");
...
function keccakAsU8a(value) {
  ...
  return !_util.hasBigInt || !onlyJs && (0, _wasmCrypto.isReady)() ? is256 ? (0, _wasmCrypto.keccak256)(u8a) : (0, _wasmCrypto.keccak512)(u8a) : is256 ? (0, _sha.keccak_256)(u8a) : (0, _sha.keccak_512)(u8a);
}
/**
 * @name keccak256AsU8a
